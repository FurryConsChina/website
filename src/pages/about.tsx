    ...
    <div>
      <div className="">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">关于我们</h2>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4 text-slate-500">
          ...
          <p>
            我们当前的唯一官方域名是{" "}
            <a href="https://furrycons.cn" target="_blank" rel="noreferrer" className="text-red-400 underline">
              furrycons.cn
            </a>
            ，{" "}
            <a href="https://furryeventchina.com" target="_blank" rel="noreferrer" className="text-red-400 underline">
              furryeventchina.com
            </a>
            是我们的旧有域名，访问会跳转到前者。
          </p>
      ...
      <div className="mt-6">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">免责申明</h2>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-4">
          ...
          <p className="text-slate-500">如您需要更新/撤下展会相关内容，请随时联系我们，联系方式见下方。</p>
        </div>
      </div>
      ...
      <div className="mt-6" id="contact">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">联系方式</h2>
        </div>
        <div className="">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <h3 className="text-lg text-slate-600 mb-2 group-hover:text-white transition duration-300">QQ群</h3>
              <p className="text-red-400 underline group-hover:text-white transition duration-300">630572929</p>
            </a>
            ...
            <a
              ...
              className="bg-white rounded-xl shadow-sm p-4 group hover:shadow-md hover:-translate-y-2 hover:bg-red-300 transition duration-300"
            >
              <h3 className="text-lg text-slate-600 mb-2 group-hover:text-white transition duration-300">邮箱</h3>
      ...
      <div className="my-6">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">贡献者</h2>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Moderators.map((moderator) => (
            ...
            >
              <img src={moderator.avatar} alt={moderator.name} className="w-20 h-20 rounded-full" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
          {Contributors.map((contributor) => (
            ...
            >
              <img src={contributor.avatar} alt={contributor.name} className="w-20 h-20 rounded-full" />
              <h3 className="text-lg text-slate-600 font-bold mt-2 group-hover:text-white transition duration-300">
                {contributor.name}
              </h3>
              <p className="text-slate-500 m-0 p-0 group-hover:text-white transition duration-300">
      ...
      <div className="my-6">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">特别鸣谢</h2>
        </div>
        <div className="grid grid-cols-1 gap-4">
          <div className="bg-white rounded-xl shadow-sm p-4">
            ...
            <p className="text-slate-500">本站在日常运营过程中使用了来自 兽人控游戏库 的基础设施：Umami 和 Sentry。</p>
          </div>
        </div>
      </div>
      ...
      <div className="my-6">
        <div className="flex justify-center">
          <h2 className="text-lg text-white mb-4 bg-geraldine rounded-full w-fit px-4">友情链接</h2>
        </div>
